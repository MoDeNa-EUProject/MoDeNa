...
const char beg_coord_psfx[]= ".sco"; //.sco - Anfangszustand bei zufälliger Erzeugung 
...
char beg_coord_name[80];      //.sco - Anfangszustand bei zufälliger Erzeugung
...
FILE* beg_coord_file= NULL;      //.sco - Anfangszustand bei zufälliger Erzeugung 
...
//Parameter für Verteilungsfunktionen
int     Distrfunct= 0;
double  Alpha  = 2.0;
double  Lambda = 0.04;
double  Mu     = 1.0;
...
****************************************************************
    ...
    Anlegen und Öffnen der Projektdateien
...
int read_param(void)
{
   ...
   //weitere Parameter für die Verteilungen
   fgets(line, 80, gen_par_file);
   l++;
   ...
   else
   {
      if(Vv < 0 || Vv > 1)
      {
         printf("Volumenverhältnis muss positiv sein und zwischen 0 und 1 liegen.\n");
         fehlerAusgabe("read_param", -1);
      }
   }
...
****************************************************************
    ...
    durch Einlesen oder zufälliges Erzeugen
...
****************************************************************
    ...
    für die Verwaltung der Zellzerlegung und 
...
****************************************************************
    ...
    Berechnen der Verschiebung für alle Zellen
...
****************************************************************
    ...
    Freigeben von Speicherbereichen und Schließen von Dateien
