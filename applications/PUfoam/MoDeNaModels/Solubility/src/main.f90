...
!! ----------------------------------------------------------------------
      ...
      eos = 1                     ! eos=1: use PC-SAFT equation of state
      pol = 1                     ! pol=1: include polar interactions (use PCP-SAFT parameters) 
 
      p = 1.000e05                ! pressure is fixed to 1bar in all simulations
...
!! ----------------------------------------------------------------------
      ...
      CALL VLE_MIX(rhob,density,chemPot_total,compID) ! call routine that calculates phase equilibria
