!> @file      bubbleGrowth/src/src/interpolation.f90
...
!!
!! Piecewise linear interpolation or extrapolation. Function is defined
!! by discrete points. Subroutine can interpolate several points as once.
